...
int main(int argc, char *argv[])
{
    ...
    if (a.arguments().contains("-h") || a.arguments().contains("--help")) {
        ...
        fprintf(stderr, "Usage: %s [-vo qt/gl/d2d/gdi] [url/path]filename", a.applicationFilePath().section(QDir::separator(), -1).toUtf8().constData());
    ...
    QStringList qms;
    qms << "Xuno-QtAV" << "Xuno-QtAV player" << "qt";
